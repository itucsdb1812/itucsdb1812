...
INIT_STATEMENTS = [
            ...
            "CREATE TABLE USERPLAYLIST (PLAYLIST_ID SERIAL PRIMARY KEY, PLAYLISTNAME VARCHAR(100) NOT NULL, USERID INTEGER REFERENCES USERS (ID) ON DELETE CASCADE )",
            ...
            "CREATE TABLE PLAYLISTMUSIC (ID SERIAL PRIMARY KEY, USERPLAYLISTID INTEGER REFERENCES USERPLAYLIST (PLAYLIST_ID) ON DELETE CASCADE, MUSICID INTEGER REFERENCES MUSIC (MUSIC_ID) ON DELETE CASCADE )",
]
