...
INIT_STATEMENTS = [
            ...
            "CREATE TABLE MUSIC (MUSIC_ID SERIAL PRIMARY KEY, MUSICNAME VARCHAR(30) NOT NULL, ARTIST VARCHAR(30), MUSICTYPE VARCHAR(20), RELEASEDATE VARCHAR(10), ALBUMNAME VARCHAR(20), MUSICLANGUAGE VARCHAR(15), MUSICCOUNTRY VARCHAR(20) )",
